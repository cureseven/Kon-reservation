...
class ReservesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserf" do
    assert_difference('Reserve.count') do
      post reserves_url, params: { reserf: { date: @reserf.date, name: @reserf.name, section: @reserf.section } }
    end
  ...
  test "should update reserf" do
    patch reserf_url(@reserf), params: { reserf: { date: @reserf.date, name: @reserf.name, section: @reserf.section } }
